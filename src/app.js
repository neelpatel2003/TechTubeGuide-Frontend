...
// Add Google Fonts import for a modern, vibrant look
const inter = document.createElement('link');
inter.href = 'https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;800&display=swap';
...
const darkTheme = createTheme({
    palette: {
        mode: 'dark',
        background: {
            default: 'linear-gradient(135deg, #23263a 0%, #2563eb 100%)', // Vibrant blue gradient
            paper: 'rgba(35,38,58,0.95)',
        },
        text: {
            primary: '#fff',
            secondary: '#cbd5e1',
    ...
    components: {
            ...
            styleOverrides: {
                root: {
                    ...
                    '&:hover': {
                        ...
                        boxShadow: '0 16px 40px 0 rgba(37,99,235,0.20)', // blue shadow
                    },
                },
            },
        },
        ...
        MuiOutlinedInput: {
            styleOverrides: {
                ...
                root: {
                    background: 'rgba(60,60,120,0.07)',
                    borderRadius: 10,
                },
            },
        },
        ...
        MuiChip: {
            styleOverrides: {
                root: {
                    ...
                    color: '#fff',
                    boxShadow: '0 1px 8px 0 rgba(37,99,235,0.14)',
                },
            },
        },
    },
    ...
    return (
        <ThemeProvider theme={darkTheme}>
            ...
            <Box minHeight="100vh" sx={{
                background: `linear-gradient(135deg, #23263a 0%, #2563eb 100%), url('data:image/svg+xml;utf8,<svg width=\'100%25\' height=\'100%25\' xmlns=\'http://www.w3.org/2000/svg\'><rect fill=\'none\' width=\'100%25\' height=\'100%25\'/><g stroke=\'%2366aaff\' stroke-width=\'0.7\' opacity=\'0.16\'><path d=\'M0 40h1000M0 80h1000M0 120h1000M40 0v1000M80 0v1000M120 0v1000\'/></g></svg>')`,
                            ...
                            <Card sx={{ bgcolor: 'background.paper', boxShadow: 3, borderRadius: 3, p: 2, position: 'sticky', top: 90 }}>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 2 }}>
                                    <Button
                                        ...
                                        sx={{ minWidth: 60, fontSize: '0.85rem', px: 1.5, py: 0.5 }}
                                    >
                                        Previous
                                    </Button>
                                        ...
                                        <Box sx={{ display: { xs: 'block', md: 'flex' }, alignItems: 'flex-start', gap: 4 }}>
                                            ...
                                            <Box sx={{ flex: '2 1 500px', minWidth: 0, p: { xs: 0, md: 2 } }}>
                                                ...
                                                <Typography variant="subtitle1" color="text.secondary" mb={1} sx={{ fontSize: { xs: '1rem', md: '1.2rem' } }}>
                                                    Channel: {normalizedSelectedCourse.channelName}
                                                </Typography>
                                                ...
                                                <Typography variant="body1" color="#bfc7d5" sx={{ mb: 2, fontSize: { xs: '1rem', md: '1.1rem' } }}>
                                                    Description: {normalizedSelectedCourse.contentAvailable}
                                                </Typography>
